      ...
      <div className="px-4 py-3 border-t border-border-subtle flex gap-2">
        ...
        {isProcessing ? (
          ...
          <Link
            ...
            className="flex-1 flex items-center justify-center gap-1.5 bg-transparent border border-border-subtle text-text2 rounded-lg py-2 text-[12px] hover:border-border-purple hover:text-purple-light transition-all"
          >
          ...
          <Link
            href={`/portal/lectures/${lectureId}`}
            className="flex-1 flex items-center justify-center gap-1.5 bg-transparent border border-border-subtle text-text3 rounded-lg py-2 text-[12px] hover:border-border-purple hover:text-text2 transition-all"
          >
            Ver detalhes
          </Link>
        )}
