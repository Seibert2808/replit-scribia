...
export default async function EventDetailPage({ params }: Props) {
  ...
  const event = data as unknown as {
    ...
    cover_image_url: string | null; status: string; created_at: string; updated_at: string;
    materials_access_days: number | null; primary_color: string | null;
    secondary_color: string | null; logo_url: string | null;
  } | null
  if (!event) notFound()
