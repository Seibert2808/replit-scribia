...
export function PortalContent({ lectures, stats }: PortalContentProps) {
    ...
    <div className="max-w-[1100px] mx-auto px-4 sm:px-6 md:px-10 py-6 md:py-9">
      ...
      {activeLecture && (
        <div ref={playerRef}>
          ...
          />
          <EbookPreview content={activeLecture.ebook_content} lectureId={activeLecture.id} />
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-4.5 stagger-children">
          {lectures.map((lecture, i) => (
            <LectureCard
              ...
              hasEbook={lecture.has_materials}
              gradientIndex={i}
