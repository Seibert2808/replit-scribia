...
export const COPY = {
  ...
  howItWorksSteps: [
    ...
    { title: "Entrega Imediata", desc: "Receba diretamente na plataforma ou faça o download para o seu celular, tablet ou computador para compartilhar com sua equipe. Versões em pdf ou em arquivo ediátvel." },
  ],
  benefits: [
