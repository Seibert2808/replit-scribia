      ...
      <div className="flex min-h-screen items-center justify-center bg-bg">
        <div className="w-full max-w-md bg-bg2 border border-border-subtle rounded-2xl p-8 animate-fade-up">
          ...
          <p className="text-[13px] text-text2 text-center mt-3">
            Enviamos um link para <strong className="text-purple-light">{email}</strong>.<br />Clique no link para definir sua senha.
          </p>
          <p className="text-[12px] text-text3 text-center mt-4">
            Não recebeu?{' '}
            <button onClick={() => setSent(false)} className="text-purple-light hover:text-purple transition-colors">tente novamente</button>
          </p>
          <Link href="/login" className="flex items-center justify-center gap-2 mt-6 text-[13px] text-text3 hover:text-purple-light transition-colors">
    ...
    <div className="flex min-h-screen items-center justify-center bg-bg">
      <div className="w-full max-w-md bg-bg2 border border-border-subtle rounded-2xl p-8 animate-fade-up">
        <div className="text-center mb-8">
          ...
          <p className="text-[13px] text-text3 mt-2">Informe seu email para redefinir sua senha</p>
        </div>
