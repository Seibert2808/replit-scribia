...
| **9** | **Livebooks Multi-Perfil & Enriquecimento de Speaker** | 9.1 — 9.4 | **P0 (Must)** |
| **10** | **Painel do Palestrante — Dashboard de Leads & Gestao** | 10.1 — 10.4 | **P0 (Must)** |
...
| **9.1** | **Schema Multi-Perfil de Livebooks** | **Draft** | ⏳ 0% | Tabelas lecture_materials, generation_configs, speaker enrichment |
| **9.2** | **UI de Seleção de Perfis** | **Draft** | ⏳ 0% | Checkbox grid 6 perfis, config por evento/palestra |
| **9.3** | **Pipeline de Geração Multi-Perfil** | **Draft** | ⏳ 0% | Loop multi-perfil no process-lecture, injeção bio speaker |
| **9.4** | **Onboarding Speaker com Bio** | **Draft** | ⏳ 0% | Form enriquecido, banner incentivo, /speaker/profile |
| **10.1** | **Schema de Engajamento & Analytics** | **Ready** | ✅ 100% | Migration completa: tabelas, view, RLS, triggers, bucket |
| **10.2** | **Dashboard do Palestrante — Visao de Leads** | **Ready** | ✅ 100% | Layout, sidebar, KPIs, lead cards, filtros, empty states |
| **10.3** | **Gestao de Palestra — Solicitacoes & Uploads** | **Ready** | ✅ 100% | Lectures list, change requests, file upload/list, pending requests |
| **10.4** | **Frase de Destaque & Card de Stories** | **Ready** | ✅ 100% | Highlight quote, sugestoes, card preview, download PNG |
...
### Wave 8 — Fluxo Completo do Palestrante (Stories 8.1 — 8.5) ✅ DONE
...
### Wave 9 — Livebooks Multi-Perfil & Enriquecimento de Speaker (Stories 9.1 — 9.4) ⬅️ PRÓXIMA
6 perfis de livebook (Junior/Pleno/Senior × Compacto/Completo), bio enriquecida do palestrante, pipeline multi-perfil.

| Story | Descrição | Dependências | Points |
|-------|-----------|--------------|--------|
| **9.1** | Schema Multi-Perfil + System Prompts | 1.2, 8.1 | 5 |
| **9.2** | UI de Seleção de Perfis | 9.1, 7.1, 5.3 | 5 |
| **9.3** | Pipeline de Geração Multi-Perfil | 9.1, 3.3, 1.5, 8.1 | 8 |
| **9.4** | Onboarding Speaker com Bio | 9.1, 8.1, 8.2 | 3 |

**Ordem de execução:** 9.1 → (9.2 + 9.4 em paralelo) → 9.3
**Total:** 21 story points

### Wave 10 — Painel do Palestrante — Dashboard de Leads & Gestao (Stories 10.1 — 10.4)
Dashboard do palestrante com visao de leads engajados, gestao de palestra (solicitacoes/uploads), e card de stories com frase de destaque.

| Story | Descricao | Dependencias | Points |
|-------|-----------|--------------|--------|
| **10.1** | Schema de Engajamento & Analytics | 8.1, 1.2, 9.1, 1.4 | 5 |
| **10.2** | Dashboard do Palestrante — Visao de Leads | 10.1, 8.1, 8.2, 9.4 | 8 |
| **10.3** | Gestao de Palestra — Solicitacoes & Uploads | 10.1, 10.2, 8.1, 1.4 | 5 |
| **10.4** | Frase de Destaque & Card de Stories | 10.1, 10.3, 10.2, 6.1 | 3 |

**Ordem de execução:** 10.1 → 10.2 → (10.3 + 10.4 em paralelo)
**Total:** 21 story points
...
9.1 (Multi-Profile Schema) ← 1.2, 8.1
9.2 (Profile Selection UI) ← 9.1, 7.1, 5.3
9.3 (Multi-Profile Pipeline) ← 9.1, 3.3, 1.5, 8.1
9.4 (Speaker Bio Onboarding) ← 9.1, 8.1, 8.2

10.1 (Engagement Schema) ← 8.1, 1.2, 9.1, 1.4
10.2 (Speaker Leads Dashboard) ← 10.1, 8.1, 8.2, 9.4
10.3 (Lecture Management) ← 10.1, 10.2, 8.1, 1.4
10.4 (Highlight Quote & Card) ← 10.1, 10.3, 10.2, 6.1
```
